...
Actions:
  ...
  show month       Shows all entries for the month
    ...
    _ = parser.add_argument('action', help='refer to actions')
    _ = parser.add_argument('comment', nargs='?', default='', help='strings that are tied to the punch')

    # Parse all command line arguments
    args = parser.parse_args(args)

    if args.action in ("p", "punch"): punch_clock.punch(args.comment)
